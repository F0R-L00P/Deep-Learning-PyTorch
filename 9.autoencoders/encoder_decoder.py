# first stage -> downlaod dataset
# i.e. faces of the people wanting to swap
import os
import torch
import torchvision
...
def vae_loss(reconstructed, original, mu, logvar, beta=1.0):
    ...
    reconstruction_loss = F.binary_cross_entropy(reconstructed.view(-1, 1, 28, 28), original, reduction='sum')
    # KL Divergence
...
for epoch in range(1, epochs + 1):
    ...
    testing_stage(epoch)
    with torch.no_grad():
        # Get rid of the encoder and sample z from the gaussian ditribution 
