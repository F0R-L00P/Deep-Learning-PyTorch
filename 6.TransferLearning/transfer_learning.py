...
def main():
    ...
    test_subset = torch.utils.data.Subset(val_dataset, random_indices)
    ...
    #######################SAVE MODEL#########################
    # Save Model Weights
    torch.save(resnet18.state_dict(), 'ResNet18_Transfer_Learning_model_weights.pth')
